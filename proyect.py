...
def registro():
    ...
    contra_entrada.pack()
    Label(pantalla1, text = "").pack()  
    Button(pantalla1, text = "Registro Tradicional",bg="#bfff91", width = 15, height = 1, command = registrar_usuario).pack()  #Creamos el boton

    
    Label(pantalla1, text = "").pack()
    Button(pantalla1, text = "Registro Facial",bg="#bfff91", width = 15, height = 1, command = registro_facial).pack()
